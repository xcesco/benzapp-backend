...
public class RifornimentoCriteria implements Serializable, Criteria {
    ...
    public FloatFilter litriErogati() {
        if (litriErogati == null) {
            litriErogati = new FloatFilter();
        }
        return litriErogati;
    }
    ...
    public FloatFilter sconto() {
        if (sconto == null) {
            sconto = new FloatFilter();
        }
        return sconto;
    }
    ...
    public FloatFilter prezzoAlLitro() {
        if (prezzoAlLitro == null) {
            prezzoAlLitro = new FloatFilter();
        }
        return prezzoAlLitro;
    }
    ...
    public TipoCarburanteFilter tipoCarburante() {
        if (tipoCarburante == null) {
            tipoCarburante = new TipoCarburanteFilter();
        }
        return tipoCarburante;
    }
    ...
    public LongFilter gestoreId() {
        if (gestoreId == null) {
            gestoreId = new LongFilter();
        }
        return gestoreId;
    }
