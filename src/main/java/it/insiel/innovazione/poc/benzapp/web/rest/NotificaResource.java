...
import it.insiel.innovazione.poc.benzapp.service.NotificaQueryService;
...
/**
 * REST controller for managing {@link it.insiel.innovazione.poc.benzapp.domain.Notifica}.
 */
@RestController
@RequestMapping("/api")
public class NotificaResource {
    ...
    public ResponseEntity<NotificaDTO> createNotifica(@Valid @RequestBody NotificaDTO notificaDTO) throws URISyntaxException {
        ...
        return ResponseEntity
            .created(new URI("/api/notificas/" + result.getId()))
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PutMapping("/notificas/{id}")
    public ResponseEntity<NotificaDTO> updateNotifica(
        @PathVariable(value = "id", required = false) final Long id,
        @Valid @RequestBody NotificaDTO notificaDTO
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PatchMapping(value = "/notificas/{id}", consumes = "application/merge-patch+json")
    public ResponseEntity<NotificaDTO> partialUpdateNotifica(
        @PathVariable(value = "id", required = false) final Long id,
        @NotNull @RequestBody NotificaDTO notificaDTO
    ) throws URISyntaxException {
    ...
    public ResponseEntity<List<NotificaDTO>> getAllNotificas(NotificaCriteria criteria, Pageable pageable) {
