package it.insiel.innovazione.poc.benzapp.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, it.insiel.innovazione.poc.benzapp.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, it.insiel.innovazione.poc.benzapp.repository.UserRepository.USERS_BY_EMAIL_CACHE);
            ...
            createCache(cm, it.insiel.innovazione.poc.benzapp.domain.Fascia.class.getName() + ".cittadinos");
