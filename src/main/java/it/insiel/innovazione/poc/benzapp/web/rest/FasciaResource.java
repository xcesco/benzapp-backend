...
public class FasciaResource {
     ...
     */
    @GetMapping("/fascias")
    public ResponseEntity<List<Fascia>> getAllFascias(Pageable pageable) {
        log.debug("REST request to get a page of Fascias");
        Page<Fascia> page = fasciaService.findAll(pageable);
