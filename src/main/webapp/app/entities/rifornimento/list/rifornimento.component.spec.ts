...
describe('Component Tests', () => {
  describe('Rifornimento Management Component', () => {
    let comp: RifornimentoComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(RifornimentoComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.rifornimentos?.[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
