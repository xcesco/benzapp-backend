...
describe('Component Tests', () => {
  describe('Cittadino Management Component', () => {
    let comp: CittadinoComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(CittadinoComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.cittadinos?.[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
