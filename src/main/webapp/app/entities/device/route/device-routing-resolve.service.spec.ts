...
describe('Service Tests', () => {
  describe('Device routing resolve service', () => {
    ...
    describe('resolve', () => {
      it('should return existing IDevice for existing id', () => {
        // GIVEN
        service.find = jest.fn(id => of(new HttpResponse({ body: new Device(id) })));
        ...
        expect(resultDevice).toEqual(new Device(123));
      });
